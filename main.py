...
if __name__ == '__main__':
    ...
    #save to xslx - extended
    students[['GRUPPO', 'MATRICOLA', 'COGNOME', 'NOME', course_column]].sort_values(['GRUPPO', 'COGNOME'], ascending=True).to_excel('students-output.xlsx', sheet_name="Gruppi P&T 2024", index=False)
    ...
    for column in sheet.columns:
        ...
        sheet.column_dimensions[column_letter].width = adjusted_width
    # Save the modified Excel file
    workbook.save('students-output-extended.xlsx')
